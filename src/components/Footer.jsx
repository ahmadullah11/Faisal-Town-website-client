        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-sm">
              <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700 hover:border-amber-400/30 transition-all">
            ...
            <div className="space-y-2 text-sm">
              {[
                ...
                <a
                  key={index}
                  href={link.href}
                  className="block text-gray-300 hover:text-amber-400 transition-all hover:translate-x-1 py-0.5"
                >
                  {link.name}
                </a>
              ))}
                ...
                {[
                  ...
                  return (
                    <a
                      ...
                      className="w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center hover:bg-amber-400 hover:scale-105 transition-all"
                    >
                      <Icon className="w-4 h-4 text-gray-300 group-hover:text-slate-900" />
                    </a>
                  );
                })}
              </div>
