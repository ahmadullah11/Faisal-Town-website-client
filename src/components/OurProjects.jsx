...
const OurProjects = () => {
  ...
  const ProjectCard = ({ project, isLarge = false }) => (
    <div className={`group relative overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-500 ${isLarge ? 'col-span-2 row-span-2' : ''}`}>
      <div className="relative overflow-hidden">
        <img
          src={project.image}
          alt={project.name}
          className={`w-full object-cover transition-all duration-700 group-hover:scale-110 ${isLarge ? 'h-56 lg:h-72' : 'h-60'}`}
        />
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Faisal Town continues to grow with innovative developments, providing modern infrastructure and world-class amenities to thousands of happy families.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <div className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-bold text-gray-900">50,000+</h3>
